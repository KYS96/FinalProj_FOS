...
// 밑에 function 안에 들어있던 거 밖으로 뺌
// Percent Chart (상품 판매 순위 - 도넛차트)
//여기서는 판매량을(수치)
const loadSalesChart = (NUM1, NUM2, NUM3, NUM4, categoryName1, categoryName2, categoryName3, categoryName4) => {
  console.log("실행됨")
